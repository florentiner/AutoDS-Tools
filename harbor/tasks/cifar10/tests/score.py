"""Score CIFAR-10 (accuracy). Always writes a reward (0.0 on failure)."""
...
def main() -> int:
    ...
    acc = float((pd.to_numeric(m["label_true"],errors="coerce")==pd.to_numeric(m["label_pred"],errors="coerce")).mean())
