# Ecom Offers — tabular (classification) with a temporal split

You are solving the TabReD **ecom-offers** task: predict whether a customer redeems an e-commerce offer. This is real-world
