# Delivery Eta — tabular (regression) with a temporal split

You are solving the TabReD **delivery-eta** task: predict the delivery ETA of an order (minutes). This is real-world
