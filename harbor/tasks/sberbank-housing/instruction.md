# Sberbank Housing — tabular (regression) with a temporal split

You are solving the TabReD **sberbank-housing** task: predict the sale price of a property. This is real-world
