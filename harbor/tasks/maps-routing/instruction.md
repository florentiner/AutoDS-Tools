# Maps Routing — tabular (regression) with a temporal split

You are solving the TabReD **maps-routing** task: predict the real travel time of a route (seconds). This is real-world
