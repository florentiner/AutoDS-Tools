# Homecredit Default — tabular (classification) with a temporal split

You are solving the TabReD **homecredit-default** task: predict whether a loan applicant will default. This is real-world
