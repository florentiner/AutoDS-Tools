# Cooking Time — tabular (regression) with a temporal split

You are solving the TabReD **cooking-time** task: predict the cooking time of a restaurant order (minutes). This is real-world
